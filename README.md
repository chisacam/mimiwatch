...
유튜브 탭에서 확장 아이콘을 누르면 팝업이 뜹니다. **무엇을 얹을까요**에서
받아 둔 라이브 세션이나 녹화본을 고르면 그 자막이 화면에 붙습니다. 자막
모드·글자 크기·배경·오프셋은 팝업에서 조절하고, 자리는 자막을 끌어 옮깁니다.

세션을 시작하고 관리하는 일은 mimiwatch 페이지가 그대로 맡습니다. 팝업이
답하는 것은 「이 탭에 어느 자막을 얹을까」 하나입니다 — 목록·추가·엔진 설정을
팝업에 다시 지으면 두 벌이 됩니다.
